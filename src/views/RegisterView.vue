            ...
            <v-card class="auth-card">
              <v-toolbar color="primary">
                <v-toolbar-title class="toolbar-title">
                  <v-icon class="toolbar-icon">mdi-account-plus</v-icon>
                  <span class="toolbar-text">Daftar</span>
                </v-toolbar-title>
              </v-toolbar>
              ...
              <v-card-text class="card-content">
                <v-form @submit.prevent="handleRegister">
                  ...
                  <v-text-field
                    ...
                    color="primary"
                    class="input-field"
                    :rules="[rules.required, (value) => rules.passwordMatch(value, password)]"
                    placeholder="Password"
              ...
              <v-card-actions class="card-actions">
                <v-btn variant="text" color="secondary" class="register-btn" to="/login">
                  Sudah Punya Akun
                </v-btn>
              </v-card-actions>
            </v-card>
...
const rules = {
  ...
  passwordMatch: (value: string, password: string) => {
    return value === password || 'Konfirmasi password tidak sesuai'
  },
}
